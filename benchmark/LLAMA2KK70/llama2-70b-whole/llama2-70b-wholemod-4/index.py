...
with torch.inference_mode():
    model= torch.load('/data/model/openfaas/cdgp/wholegraphs/llama2-70b//llama2-70b-wholemod-4.pt', map_location=infer_device)
    # warm up 
    ...
    x = torch.load("/data/model/openfaas/cdgp/wholegraphs/llama2-70b/llama2-70b-wholemod-inputs-4.pt", map_location=infer_device)
    output = model(**x)
